    ...
    return (
        <>
            ...
            <div className='checkout-button-container'>
                <div className='checkout-button-container__btn' style={{display:displaySn?'none':'block'}}>
                    <Button
                        className="Btn"
                        btnText="Log in"
                        bgColor='#f9fcf2'
            ...
            <div className='checkout-button-container__btn checkout' style={{display:display?'none':'block'}}>
                    <CheckoutButton />
            </div>
